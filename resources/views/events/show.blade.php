...
<div class="sm:px-6 w-full">
    ...
    <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
        <div class="overflow-x-auto">
            <button class="w-full py-3 my-4 text-sm focus:outline-none leading-none text-gray-700 bg-gray-100 rounded" onclick="window.history.go(-1); return false;">Back</button>
